...
// Initialize a payment submission
router.post('/initialize', paymentController.createPaymentSubmission);

// Submit payment proof (transaction code and/or uploaded proof receipt image)
router.post('/:paymentId/proof', uploadProof.single('paymentProof'), paymentController.submitPaymentProof);
